...
- ⏭ **NEXT (only free deterministic levers remain):** (1) continue over-capture batches (CN R42 shipped −31, 2026-06-24) until each juris's clean trailing-verb pool is dry; (2) open **WS-D** Engine 2 (spec-support) + Engine 3 (ref-numeral) sweeps — untouched FP pools, deterministic FN-guards; (3) full 86k benign-rate characterization. **Do NOT spend judging-$ on the discriminator** (proven dead). The irreducible semantic tail stays in the FIX bucket — an AI-free §112(b) checker ceiling, framed as candidate flags for attorney review.
