...
158 checks against USPTO MPEP, EPO Guidelines, CNIPA 审查指南, and TIPO 專利審查基準, covering U.S., European (EPC), Chinese, and Taiwanese patent application drafts. Your file never leaves your device — verifiable in airplane mode.

**[Try it →](https://patentlint.com)**

## Status

- **Check catalog**: 43 U.S. + 37 EPC + 35 CN + 43 TW = 158 deterministic checks; per-jurisdiction breakdown in [CHECKS.md](CHECKS.md)
...
2. **Analyze** — 158 checks run instantly via WebAssembly (no server, no upload)
...
158 automated checks across four jurisdictions, each classified as **PASS**, **REVIEW**, or **FIX**.
