...
export default function SectionPanel({
  ...
  return (
    <div>
      <FrostCard tier="resting" interactive className="overflow-visible">
        <button
          className="flex w-full items-center justify-between px-4 py-3 text-left transition-colors duration-[var(--motion-duration-fast)]"
      ...
      {open && (
        <FrostCard tier="resting" className="mt-2 space-y-1 p-2 animate-in fade-in-0 slide-in-from-top-1 duration-[var(--motion-duration-base)]">
          {checks.map((check, i) => (
